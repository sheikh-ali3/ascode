  ...
  return (
    <div className='bg-black fomt-Arial'>
      <nav className='m-[10px] bg-black text-white p-[30px] text-center text-[30px] relative'>
        <Image className='mr-[10px] float-left mt-[10px] pl-[30px] pr-[20px]' src="/public/Systems and technology programming company logo.png" alt="Logo" width={100} height={50}/>
        ...
        <ul>
            ...
            <li className='inline mr-[10px] pl-[20px]'>
                <a href="services.html">Services<span></span></a>
                <ul className='none absolute bg-black text-left pr-[1500px]'>
